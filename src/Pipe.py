...
class Pipe:
    ...
    def __init__(self, WIN, x, y):
        ...
        self.x = x
        self.bottomY = y
        self.__pipe_up = pygame.transform.scale(Pipe.pipeGraphic, (75, Pipe.settings["HEIGHT"] * .6)).convert_alpha()
        self.__pipe_down = pygame.transform.flip(self.__pipe_up, False, True).convert_alpha()
